...
export interface IMessageRepository {
  ...
  findConversation(sender_id: string, receiver_id: string, offset: number, limit: number): Promise<MessageType[]>;
...
export class MessageRepository implements IMessageRepository {
  ...
  async findConversation(sender_id: string, receiver_id: string, offset: number, limit: number): Promise<MessageType[]> {
